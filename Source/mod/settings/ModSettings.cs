...
namespace DarkIntentionsWoohoo.mod.settings
{
    ...
    {
        public static readonly float base_woohooChildChance = 0.01f;
        public static readonly float base_woohooBabyChildChance = 0.5f;

        public static readonly bool base_sameGender = true;
